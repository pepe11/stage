...
\begin{itemize}
		...
		\item Illustrazione dello schema della base di dati necessaria al chatbot per gestire la logica decisionale (diversa dalla base dati aziendale);
...
\begin{itemize}
		\item Ricerca e studio approssimativo dei possibili framework di sviluppo, consultandone la documentazione ufficiale e implementando semplici esempi;

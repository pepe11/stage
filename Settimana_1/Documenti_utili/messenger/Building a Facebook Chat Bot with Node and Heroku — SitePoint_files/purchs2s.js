        ...
        if (bid.divid===id) {
          ...
          if (typeof markup!='undefined' && markup!=null && markup) {
            ...
            if (doc.defaultView && doc.defaultView.frameElement) {
              var width  = bid.size.w+"px";
              var height = bid.size.h+"px";
...
(function(){try{var a=document.createElement("span"),b=Math.floor(Math.random()*11E3);a.style.display="none";var c=document.location.protocol=="https:"?"https":"http";a.innerHTML='<iframe style="display:none" src="//sync.aralego.com/idSync/?ucf_nid=par-2EE948B3EA8B6A90994284DE3BE42B&ucf_user_id=0ADE3D695A90455595606C3139D93756&redirect='+c+"%3A%2F%2Fads.servebom.com%2Fpartner%3Fcd%3D"+b+'%26svc%3Dus%26id%3D31%26uid%3DUCFUID"></iframe>';document.body.appendChild(a)}catch(d){console.error(d)}})();

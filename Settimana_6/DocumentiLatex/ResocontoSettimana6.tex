...
\bigskip
\begin{center}
{\Huge \textbf{Resoconto Settimana 6}} \\ 
{\textbf{18/12/2017 - 22/12/2017}} \\ \bigskip
...
Di seguito sono riportati gli argomenti di discussione del meeting, avvenuto il 20/12/2017:
\begin{itemize}
		\item Valutazione del prototipo sviluppato, in termini di funzionalità implementate;
		\item Valutazione del prototipo sviluppato, in termini di User Interface e modalità di interazione con l'utente (struttura e gestione dei dialoghi);
		\item Discussione di modifiche richieste dal tutor aziendale;
		\item Discussione delle ultime funzionalità che dovranno essere implementate.
\end{itemize} 
...
\bigskip
\section*{Attività}
Di seguito sono riportate le attività svolte durante la settimana 18/12/2017 - 22/12/2017:
\begin{itemize}
		\item Implementazione dei test di unità non completati la settimana precedente;
		\item Implementazione delle modifiche richieste dal tutor aziendale;
		\item Implementazione delle restanti componenti software;
		\item Integrazione al prototipo delle ultime funzionalità sviluppate.
\end{itemize}
...
Questa settimana gli obiettivi prefissati sono stati raggiunti; sono state implementate tutte le funzionalità richieste, le quali sono state integrate al prototipo creato la settimana precedente. \\
Non sono stati implementati tutti i test per le unità software sviluppate in questa sesta settimana, ma si prevede si completarli all'inizio della settimana successiva senza ulteriori ritardi, in quanto la fase di verifica e collaudo richiederà meno tempo del previsto (40 ore, delle quali si prevede ne saranno necessarie 32).

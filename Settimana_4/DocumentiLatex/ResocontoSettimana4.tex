...
\bigskip
\begin{center}
{\Huge \textbf{Resoconto Settimana 4}} \\ 
{\textbf{04/12/2017 - 08/12/2017}} \\ \bigskip
...
Di seguito sono riportati gli argomenti di discussione del meeting, avvenuto il 05/12/2017:
\begin{itemize}
		\item Negoziazione della possibile architettura ad alto livello del prodotto;
		\item Negoziazione della possibile architettura di dettaglio dei moduli individuati;
		\item Necessità da parte del tutor aziendale di avere una prima versione del prototipo, avente alcune funzioni basilari;
		\item Discussione sulle caratteristiche della prima versione del prototipo richiesta.
\end{itemize} 
...
\bigskip
\section*{Attività}
Di seguito sono riportate le attività svolte durante la settimana 04/11/2017 - 08/12/2017:
\begin{itemize}
		\item Definizione dell'architettura del prototipo;
		\item Produzione di un diagramma dell'architettura ad alto livello del prototipo, la quale identifica i principali moduli del sistema;
		\item Produzione di un diagramma dell'architettura di dettaglio del prototipo, la quale identifica la maggior parte delle componenti software  necessarie a soddisfare i requisiti individuati;
		\item Implementazione di una prima versione del prototipo, avente alcune funzioni basilari.
\end{itemize}
...
Questa settimana si conferma che i risultati attesi sono stati raggiunti. Ovvero è stato prodotto un diagramma dell'architettura ad alto livello del prototipo, ed è stato prodotto un diagramma dell'architettura di dettaglio della maggior parte dei moduli. Non è stato possibile produrre un diagramma dettagliato per tutti i moduli in quanto è stato richiesto di implementare una prima versione del prototipo, avente alcune funzioni basilari; nonostante questo, si conferma che non ci sono ritardi rispetto alla pianificazione del lavoro, in quanto il diagramma dell'architettura di dettaglio verrà completato lunedì 11/12/2017, nelle ore che erano state adibite alla implementazione di una prima versione del prototipo (che è già stata in parte eseguita).
